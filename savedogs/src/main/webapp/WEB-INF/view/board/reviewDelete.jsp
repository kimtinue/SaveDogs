...
<form action="reviewDelete.dog" method="post" name="f">
<input type="hidden" name="no" value="${board_no }"/>
	<table>
		...
		<tr><th style="padding-top: 50px;">	
			<input type="button" value="취소" class="g_btn" onclick="location.href='reviewDetail.dog?no=${board_no}'">		
